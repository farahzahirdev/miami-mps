    ...
    <footer className="border-t border-mps-navy/8 bg-gradient-to-b from-white via-mps-blue/[0.06] to-mps-blue/[0.12]">
      <div className="mx-auto max-w-content px-4 py-12 sm:px-6 sm:py-14 lg:px-8 lg:py-16">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-10">
          ...
          <div>
            <h3 className="section-eyebrow mb-4">{copy.footer.treatmentsHeading}</h3>
            <ul className="space-y-2">
              {copy.footer.treatments.map((link) => (
                <li key={link.href}>
          ...
          <div>
            <h3 className="section-eyebrow mb-4">{copy.footer.conditionsHeading}</h3>
            <ul className="space-y-2">
              {copy.footer.conditions.map((link) => (
                <li key={link.href}>
                  <a href={link.href} className="nav-link text-mps-navy/80 hover:text-mps-blue">
                    {link.label}
                  </a>
