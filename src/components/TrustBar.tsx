...
export function TrustBar() {
  ...
  return (
    <section aria-label="Trust indicators" className="bg-mps-blue-light/40 py-10 sm:border-y sm:border-mps-navy/6 sm:py-14">
        ...
        <div className="grid grid-cols-2 gap-x-5 gap-y-8 sm:grid-cols-4 sm:gap-6">
          {copy.trust.items.map((item, index) => {
            ...
            return (
              <article
                key={item.value}
                className="flex flex-col items-center text-center sm:mps-card-interactive sm:px-6 sm:py-10"
              >
